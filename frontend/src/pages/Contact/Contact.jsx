...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        emailjs.send('service_wc9ivdy', 'template_rtyn4d7', values, 'vKeUvV-YpD_MiqJJS')
            .then(response => {
        ...
        <section className='py-3'>
                ...
                <div className="w-full draggable">
                    <div className="container flex flex-col items-center gap-16 mx-auto my-10">
                        <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                            <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main border ">
                                <span>
                                ...
                                <p className="text-base leading-4 text-dark-grey-600">Contact us at</p>
                                <a className="text-lg font-bold text-purple-blue-500" href="mailto:deverse2022@gmail.com">
                                    deverse2022@gmail.com
                                </a>
                            </div>
                            <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main border ">
                                <span>
                                ...
                                <p className="text-base leading-4 text-dark-grey-600">Reach out to us by phone</p>
                                <a className="text-lg font-bold text-purple-blue-500" href="tel:+919507531556">+91 9507531556</a>
                            </div>
                            <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main border ">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                                ...
                                <p className="text-base leading-4 text-dark-grey-600">Find us at our office</p>
                                <Link className="text-lg font-bold text-purple-blue-500" target="_blank" href="">
                                    Noida Sector 35, 201301
                                </Link>
                            </div>
                        </div>
                    </div>
            ...
            <div className="text-gray-600 body-font relative">
                <div className="absolute inset-0 bg-gray-300">
                    <iframe width="100%" height="100%" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7007.290770955089!2d77.35164609359336!3d28.580409452772713!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce5a27e9b9add%3A0x37bbc16277e0feb3!2sSector%2035%2C%20Noida%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1715966883519!5m2!1sen!2sin" allowFullScreen="" loading="lazy" ></iframe>
                </div>
                <div className="p-1 md:p-5 mx-auto flex">
                    <form onSubmit={handleSubmit} className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-4 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Contact Us</h2>
                        <p className="leading-relaxed my-2">
                            {status && renderAlert()}
                        </p>
                        <div className="relative mb-4">
                            <Input type="text" variant="bordered" name="fname" label="Full Name" value={values.fname} onChange={handleChange} />
                        </div>
                        <div className="relative mb-4">
                            <Input type="email" variant="bordered" name="email" label="Email" value={values.email} onChange={handleChange} />
                        </div>
                        <div className="relative mb-4">
                            <Textarea name="message" label="Your Query" labelPlacement="inside" variant='bordered' value={values.message} onChange={handleChange}></Textarea>
                        </div>
                        <Button type='submit' color='success' variant='shadow'>Send</Button>
                    </form>
                </div>
            </div>
